...
| 타입 | 특징 | 예시 이미지 |
|------|------|--------------|
| **리드선형 프로브** | 케이블 일체형, 기계·3D프린터 등에 사용 | ![리드선형 프로브](https://media.rs-online.com/C3730372-01.jpg) |
...
| **엘리먼트 단품** | 세라믹 위 백금 박막칩 형태 | ![엘리먼트 단품](https://br.omega.com/omegaFiles/Temperature/images/F1500_F2000_F4000_m.jpg) |
---
