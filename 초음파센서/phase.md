...
## 📸 예시 이미지
> ※ 이미지는 예시용으로, 실제 장비 제조사별 차이가 있습니다.

![echocardiography phased array example](https://upload.wikimedia.org/wikipedia/commons/0/00/Echocardiogram_example.gif)
*출처: Wikimedia Commons*

---

## 🩷 요약 문장
> **심장초음파는 위상배열 탐촉자 기술이 가장 성공적으로 상용화된 의료 사례**로,  
> 빠르게 움직이는 심장의 복잡한 구조를 실시간으로 영상화하여  
> **비침습적이고 정확한 진단**을 가능하게 합니다.
...
## 📚 참고 자료
- GE Healthcare — *Vivid E95 Product Overview*  
- Philips — *EPIQ Ultrasound System Series*  
- Siemens Healthineers — *Acuson SC2000 PRIME*  
- Wikipedia — *Phased array / Echocardiography*  
